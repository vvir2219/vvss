...
public class UIConsolaFake implements IConsola{

    private BufferedReader console;
    BibliotecaCtrl bc;

    public UIConsolaFake(BibliotecaCtrl bc){
        this.bc=bc;
    }
    ...
    public void cautaCartiDupaAutor(){
        ...
        try {
            for(Carte c:(lastCartiDupaAutor = bc.cautaCarte(console.readLine()))){
                System.out.println(c);
            }
        } catch (IOException e) {
            // TODO Auto-generated catch block
    ...
    public void afiseazaCartiOrdonateDinAnul(){
        ...
        try{
            ...
            for(Carte c:(lastCartiDinAnul = bc.getCartiOrdonateDinAnul(line))){
                System.out.println(c);
            }
        }catch(Exception e){
            e.printStackTrace();
    ...
    public List<Carte> lastCartiDupaAutor;
    public List<Carte> lastCartiDinAnul;
}
