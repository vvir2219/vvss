...
public class SearchByKeywordStory {
    ...
    @Test
    public void searching_by_unexisting_word_should_not_find_page() {
        anna.is_the_home_page();
        anna.looks_for("untaehountbaoecug.,dubntoeuc,.unoetabc,.ucdb,.gcb,.ulc,.bu,.huca,b.clua,.ncu,.h");
        anna.should_not_find_page();
    }
} 